...
1. As a user, I should see the timer increment every second once the page has loaded. XX
2. As a user, I can manually increment and decrement the counter using the plus and minus buttons. XX
...
4. As a user, I can pause the counter, which should 
  ...
  * pause the counter XX
  * disable all buttons except the pause button XX
  * the pause button should then show the text "resume." XX
